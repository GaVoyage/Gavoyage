-- create database gavoyage; 
-- drop database gavoyage;

-- 1. create database gavoyage; 
-- 2. use gavoyage;
-- 3. 관광지 정보 sql 실행 
-- 4. 지금 페이지 sql 실행
...
-- DROP TABLE  if exists DaillyPlan;
...
ALTER TABLE DaillyPlan
    ADD CONSTRAINT FK_DaillyPlan_content_id_Attraction_info_content_id FOREIGN KEY (content_id)
        REFERENCES Attraction_info (content_id) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE Unrecommend
    ADD CONSTRAINT FK_Unrecommend_content_id_Attraction_info_content_id FOREIGN KEY (content_id)
        REFERENCES Attraction_info (content_id) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE Recommend
    ADD CONSTRAINT FK_Recommend_content_id_Attraction_info_content_id FOREIGN KEY (content_id)
        REFERENCES Attraction_info (content_id) ON DELETE RESTRICT ON UPDATE RESTRICT;